...
parser.add_argument('--target', type=str, default='Volatility', help='target feature in S or MS task')
...
if args.is_training:
    ...
    torch.cuda.empty_cache()
'''
# Check if seq_len and pred_len are valid
if args.seq_len + args.pred_len > len(data_x):
    args.pred_len = len(data_x) - args.seq_len - 1
    print(f"Adjusted pred_len to {args.pred_len} to fit dataset size.")'''
